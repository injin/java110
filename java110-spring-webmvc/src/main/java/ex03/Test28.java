...
@Controller
@RequestMapping(value="/ex03/test28")
...
public class Test28 {
    ...
    public String m2(
            ...
            //
            // => @SessionAttributes에 지정된 이름의 값이 없다면,
            //    예외가 발생된다.
    ...
    @ResponseBody
    public String m4(
            // 다른 페이지 컨트롤러에 @SessionAttributes에서
            // 지정한 값을 받을 때?
            // => 안된다. 현재 페이지 컨트롤러에서 지정한 이름의 값만 받을 수 있다.
            // http://localhost:8888/app/ex03/test27/m1
            //  => // http://localhost:8888/app/ex03/test28/m4 순으로 테스트
