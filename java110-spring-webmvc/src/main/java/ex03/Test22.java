...
@RestController // = @Controller + @ResponseBody (안의 모든 값은 JSON으로 출력)
@RequestMapping(value="/ex03/test22")
public class Test22 {
    ...
    // => GsonHttpMessageConverter는 다음 라이브러리에 들어있다.
    //      "google-gson" 라이브러리
    //
    ...
    // 클라이언트가 보낸 데이터를 JSON 데이터를 Map 객체에 담을 수도 있다.
