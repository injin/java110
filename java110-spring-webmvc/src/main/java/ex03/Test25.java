...
@RestController
@RequestMapping(value="/ex03/test25")
public class Test25 {
    ...
    // @MatirixVariable 애노테이션을 사용하려면 스프링 설정에서 활성화시켜야 한다.
    // 1) XML 설정
    ...
    // http://localhost:8888/app/ex03/test25/search5/2001020211_2016v4
    // http://localhost:8888/app/ex03/test25/search5/2001020211_v4
    //
