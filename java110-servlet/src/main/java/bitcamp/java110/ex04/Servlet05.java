...
public class Servlet05 extends GenericServlet {
    ...
    public void service(ServletRequest req, ServletResponse res)
        ...
        // => http://localhost:8888/ex04/post2.html 페이지에서 값을 입력한 후 보내기 버튼을 클릭
        ...
        //    서블릿엥서 setCharacterEncoding()을 호출해봐야 소용없다.
...
Cookie: JSESSIONID=D5616D207D45F207FFF13AF37E34962D
*/
...
//  => 데이터 조회 화면을 요청할 떄는 POST 방식을 사용하지 않는다.
// - 보안
...
// - 바이너리 데이터 전송
//  => message-body 부분에 첨부하기 때문에 바이너리 데이터를 전홍할 수 있다.
//     단, 멀티파트 형식으로 보낸다.
// - 적용 부분
