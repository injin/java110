 ...
 * => 쿠키의 사용 범위를 지정하면 
 *    해당 범위에 있는 URL을 요청할 때 웹 브라우저가 쿠키를 보낸다.
 */
...
public class Servlet01_2 extends HttpServlet {
    ...
    public void doGet(
         ...
         * HTTP/1.1 200
            ...
            Set-Cookie: age=12; Path=/      <=== 경로 정보가 추가횐다.
            Set-Cookie: working=true; Path=/ex10/a/b   <=== 경로 정보가 추가횐다.
            Content-Type: text/html;charset=UTF-8
            Content-Length: 140
            Date: Mon, 01 Oct 2018 03:18:21 GMT
         */
