...
CREATE TABLE p2_lect (
    ...
    caps  INTEGER      NOT NULL COMMENT '모집인원', -- 모집인원
...
ALTER TABLE p2_tchr_lect
    ADD CONSTRAINT PK_p2_tchr_lect -- 강의배정 기본키
        PRIMARY KEY (
            lno, -- 강의번호
            tno  -- 회원번호
        );
...
-- 강의배정
ALTER TABLE p2_tchr_lect
    ADD CONSTRAINT FK_p2_tchr_TO_p2_tchr_lect -- 강사 -> 강의배정
        FOREIGN KEY (
            tno -- 회원번호
        )
...
-- 강의배정
ALTER TABLE p2_tchr_lect
    ADD CONSTRAINT FK_p2_lect_TO_p2_tchr_lect -- 강의 -> 강의배정
        FOREIGN KEY (
            lno -- 강의번호
        )
